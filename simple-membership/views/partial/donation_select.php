...
<option value="4035-47">Thrilling Performances</option>
</select>
...
<label for="ctl00_cp1_PAYMENTAMOUNT_freeAmount">How much would you like to donate?&nbsp;</label><input name="amount" min="1" type="number" id="amount" class="SSAfreeAmount form-control"><span id="ctl00_cp1_PAYMENTAMOUNT_ctl00_cp1_PAYMENTAMOUNT_rfv" style="color:Red;">*</span>
</div>
</fieldset>
</div></div>   
